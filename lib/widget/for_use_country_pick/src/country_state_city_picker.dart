  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //       : widget.textFieldDecoration?.copyWith(hintText: 'Select country'),
        //   readOnly: true,
        // ),
        ...
        CustomTextField(
          ...
          hintText: AppString.selectState.tr,
          enabled: true,
          readOnly: true,
          onTap: () {
                  ...
                  child: Column(
                    children: [
                      ...
                      TextField(
                        ...
                        style: TextStyle(
                            color: AppColors.calenderTextColor, fontSize: 16.0),
                              ...
                              onTap: () async {
                                setState(() {
                                  if (_title == "Country") {
                                    ...
                                    _getState(
                                        _countrySubList[index].id.toString());
                                    _countrySubList = _countryList;
                                    widget.state.clear();
                                    widget.city.clear();
                                  } else if (_title == 'State') {
